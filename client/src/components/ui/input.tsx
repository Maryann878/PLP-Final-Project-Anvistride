    ...
    return (
      <input
        ...
        className={cn(
          ...
          "[&:-webkit-autofill]:!bg-white [&:-webkit-autofill]:!text-gray-900 [&:-webkit-autofill]:!border-purple-200/50 [&:-webkit-autofill:hover]:!border-purple-300/70 [&:-webkit-autofill:focus]:!border-[#6A0DAD] [&:-webkit-autofill]:shadow-[inset_0_0_0px_1000px_white]",
          className
        )}
        {...props}
      />
